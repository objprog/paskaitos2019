...
| 7. **Klaidų ir išimčių valdymas**, laiko matavimas (`std::chrono` biblioteka), programos spartos matavimo įrankiai ir rekomendacijos, atsitiktinių skaičių generavimas. | [Teorija-Laiko matavimas](https://github.com/objprog/paskaitos2019/blob/master/slides/Teorija-LaikoMatavimas.pdf) | [Laiko matavimas](https://github.com/objprog/paskaitos2019/wiki/Laiko-matavimas) |
